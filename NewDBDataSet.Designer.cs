...
namespace informationSystem {
    ...
    public partial class NewDBDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string UserName, string UserSurname, string UserPatronymic, int UserID, string UserLogin, string UserPassword, int Type) {
...
namespace informationSystem.NewDBDataSetTableAdapters {
    ...
    public partial class TypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::informationSystem.Properties.Settings.Default.NewDBConnectionString;
        }
        ...
        public virtual int Fill(NewDBDataSet.TypeDataTable dataTable) {
        ...
        public virtual NewDBDataSet.TypeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NewDBDataSet.TypeDataTable dataTable = new NewDBDataSet.TypeDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NewDBDataSet.TypeDataTable dataTable) {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([UserID] = @Original_UserID) AND ([Type] = @Ori" +
                "ginal_Type))";
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([UserName], [UserSurname], [UserPatronymic], [UserID], [UserLogin], [UserPassword], [Type]) VALUES (@UserName, @UserSurname, @UserPatronymic, @UserID, @UserLogin, @UserPassword, @Type);
SELECT UserName, UserSurname, UserPatronymic, UserID, UserLogin, UserPassword, Type FROM Users WHERE (UserID = @UserID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [UserName] = @UserName, [UserSurname] = @UserSurname, [UserPatronymic] = @UserPatronymic, [UserID] = @UserID, [UserLogin] = @UserLogin, [UserPassword] = @UserPassword, [Type] = @Type WHERE (([UserID] = @Original_UserID) AND ([Type] = @Original_Type));
SELECT UserName, UserSurname, UserPatronymic, UserID, UserLogin, UserPassword, Type FROM Users WHERE (UserID = @UserID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT UserName, UserSurname, UserPatronymic, UserID, UserLogin, UserPassword, Ty" +
                "pe FROM dbo.Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(NewDBDataSet.UsersDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual NewDBDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            NewDBDataSet.UsersDataTable dataTable = new NewDBDataSet.UsersDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(NewDBDataSet.UsersDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Delete(int Original_UserID, int Original_Type) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string UserName, string UserSurname, string UserPatronymic, int UserID, string UserLogin, string UserPassword, int Type) {
            if ((UserName == null)) {
        ...
        public virtual int Update(string UserName, string UserSurname, string UserPatronymic, int UserID, string UserLogin, string UserPassword, int Type, int Original_UserID, int Original_Type) {
            if ((UserName == null)) {
                throw new global::System.ArgumentNullException("UserName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string UserSurname, string UserPatronymic, string UserLogin, string UserPassword, int Type, int Original_UserID, int Original_Type) {
            return this.Update(UserName, UserSurname, UserPatronymic, Original_UserID, UserLogin, UserPassword, Type, Original_UserID, Original_Type);
        }
    }
